        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 dark:text-zinc-400">
              Lokasi Eksekusi: <strong className="text-slate-700 dark:text-zinc-300">Server Local / API Bridge (Port 8000)</strong> &bull; Evaluasi Periodik setiap <strong>60 detik (Real-Time)</strong> &amp; Auto-Sync Instant.
            </p>
          </div>
