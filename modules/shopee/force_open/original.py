...
# NEW: Store ID column mappings (from Monday.com)
# Maps merchant name to the Shopee store/entity ID column in Monday
STORE_ID_COL_MAP = {
    "Foodnesia": "text_mky9x4kv",
    "WonderFood": "text_mky9tgv5",
    "Lokarasa": "text_mky9hszn",
    "DoEat": "text_mky94yev",
}
